...
title: "DeepSeek 做读书笔记：我用三层摘要法"
description: "读书笔记场景下的 DeepSeek 使用记录，包含 2026-04-22 的实测过程和可复用做法。"
date: 2026-04-22
category: "读书笔记"
tags:
  - deepseek
...
这篇只是快记，但「读书笔记」还可以继续往下测。比如同一段材料分别要求 100 字、300 字和列表版，看哪种更适合真实使用。不同长度下，DeepSeek 的表达会有明显差别。

我也会试着加一个对照样例：先给一段自己喜欢的写法，再让它模仿节奏。这样比单纯说“自然一点”更直观。2026-04-22 这次短测里，最有用的就是把抽象要求换成具体参照。
...
不需要写很复杂的提示词。你可以按这个顺序来：我想完成什么、材料是什么、不要做什么、最后给我什么格式。只要这四块写清楚，DeepSeek 在「读书笔记」这种任务里就能先给出一个可看的版本。
