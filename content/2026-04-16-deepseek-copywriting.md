...
title: "DeepSeek 写短文案：先给坏例子反而更快"
description: "文案草稿场景下的 DeepSeek 使用记录，包含 2026-04-16 的实测过程和可复用做法。"
date: 2026-04-16
category: "文案草稿"
tags:
  - deepseek
  - copywriting
  - review
cover: "https://tse-mm.bing.com/th?q=DeepSeek+%E6%96%87%E6%A1%88%E8%8D%89%E7%A8%BF"
permalink: /jiqiao/2026-04-16-deepseek-copywriting/index.html
---

## 这次我看了三项

2026-04-16 我用 DeepSeek 2026.04 桌面环境 重新试了「文案草稿」这个场景。说实话，这类任务最怕写得太大，最后看起来很厉害，实际落不到手上。我这次只看三项：输入准备、输出稳定度、后续修改成本。

![文案草稿 示意图](https://tse-mm.bing.com/th?q=DeepSeek+%E6%96%87%E6%A1%88%E8%8D%89%E7%A8%BF)
...
我不会只看第一版文字漂不漂亮，而是看它能不能减少后续修改。拿「文案草稿」来说，如果 DeepSeek 能把材料拆清楚、把语气调到差不多、把格式排好，那就已经有价值了。剩下的事实确认，还是要自己来。
...
第一，看它有没有完整覆盖原材料。第二，看有没有自己加内容。第三，看输出能不能直接复制到我要用的地方。只要这三点过关，「文案草稿」这类任务就算完成了大半。
