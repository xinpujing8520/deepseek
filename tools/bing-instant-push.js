...
const DOMAIN = process.env.BING_DOMAIN || "go-deepseek.com";
...
const BING_403_HELP = [
  ...
  "   1. 打开 https://www.bing.com/webmasters 添加 go-deepseek.com",
  "   2. 用 XML 文件 / Meta 标签 / DNS 完成所有权验证",
  "   3. 在 Settings → IndexNow 生成 key，更新 GitHub Secret INDEXNOW_KEY",
  "   4. 确保 https://go-deepseek.com/{key}.txt 内容仅为 key 本身（无换行）",
].join("\n");
